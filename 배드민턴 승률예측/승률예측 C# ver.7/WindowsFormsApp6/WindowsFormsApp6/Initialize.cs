...
namespace WindowsFormsApp6
{
    public partial class Initialize : Form
    {
        ...
        int current_set = 1;
        int p1_set1 = 0, p1_set2 = 0, p1_set3 = 0, p2_set1 = 0, p2_set2 = 0, p2_set3 = 0;
        ...
        private void get_Click(object sender, EventArgs e)
        {
            ...
            // 디스플레이 창 변경
            sd.change_winrate((p1_Winrate * 100), ((p2_Winrate) * 100));
        ...
        private void add_listview()
        {
            ...
            items.SubItems.Add((p2_Winrate * 100).ToString());
        ...
        {
            // 메모장에 결과 저장
            string savePath = @"..\승률예측 C# ver.7\경 기 결 과.txt";
            string time = DateTime.Now.ToString("yyyy-MM-dd  HH:mm:ss");
            
            StreamWriter sw = new StreamWriter(savePath, true);
            sw.WriteLine(time);
            sw.WriteLine("이름 : " + solo_player1Name + "   " + solo_player2Name);
            sw.WriteLine("국가 : " + solo_player1Nation + "   " + solo_player2Nation);
            sw.WriteLine("랭킹 : " + solo_player1Ranking + "위   " + solo_player2Ranking + "위");
            sw.WriteLine("나이 : " + solo_player1Age + "세   " + solo_player2Age + "세");
            sw.WriteLine("사전승률 : " + firstWinrate1 + "%   " + firstWinrate2 + "%");
            sw.WriteLine("1세트 : " + p1_set1 + " vs " + p2_set1);
            sw.WriteLine("2세트 : " + p1_set2 + " vs " + p2_set2);
            sw.WriteLine("3세트 : " + p1_set3 + " vs " + p2_set3);
            sw.WriteLine(" ");
            sw.Close();

            MessageBox.Show("경기가 종료되었습니다.");
        }
