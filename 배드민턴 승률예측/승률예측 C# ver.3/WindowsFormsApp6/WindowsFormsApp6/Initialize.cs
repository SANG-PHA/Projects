...
namespace WindowsFormsApp6
{
    public partial class Initialize : Form
    {
        ...
        // 전역 변수들
        Team_Display sd = new Team_Display();
        ...
        double denominator = 0, numerator = 0, p1_Winrate = 0, p1_Loserate = 0, p2_Winrate = 0, p2_Loserate = 0, AfterRate = 0;
        ...
        {
            // Team 정보 입력
            team1_player1Name = team1_player1_name.Text;
            team1_player1Nation = team1_player1_nation.Text;
            team1_player1Age = team1_player1_age.Text;
            team1_Ranking = team1_ranking.Text;
            team1_player2Name = team1_player2_name.Text;
            team1_player2Nation = team1_player2_nation.Text;
            team1_player2Age = team1_player2_age.Text;

            team2_player1Name = team2_player1_name.Text;
            team2_player1Nation = team2_player1_nation.Text;
            team2_player1Age = team2_player1_age.Text;
            team2_player2Name = team2_player2_name.Text;
            team2_player2Nation = team2_player2_nation.Text;
            team2_player2Age = team2_player2_age.Text;
            team2_Ranking = team2_ranking.Text;

            team1Winrate = int.Parse(team1_rate.Text);
            team2Winrate = 100 - team1Winrate;

            // 승률 예측 정보 변경
            p1_name_.Text = team1_player1Name + (",") + team1_player2Name;
            p2_name_.Text = team2_player1Name + (",") + team2_player2Name;
        ...
        private void get_Click(object sender, EventArgs e)
        {
            ...
            // 디스플레이 창 변경
            sd.change_winrate((int)(p1_Winrate * 100), (int)((1 - p1_Winrate) * 100));
            sd.set_winrate((int)(p1_Winrate * 100), (int)((1 - p1_Winrate) * 100));
        ...
        private void calculate2(double[] tmp)
        {
            if (who_get_score == 1)
            {
                if (highest_score == 1)
                {
                    ...
                    Console.WriteLine(p1_Winrate + " " + p1_Loserate + " " + AfterRate);
                }
                else
                {
                ...
                p1_Winrate = (double)Math.Truncate(p1_Winrate * 100) / 100;
                p1_Loserate = denominator / (numerator + denominator);
                p1_Loserate = (double)Math.Truncate(p1_Loserate * 100) / 100;

                /*p2_Winrate = denominator / (numerator + denominator);
                p2_Winrate = (double)Math.Truncate(p2_Winrate * 100) / 100;*/
                AfterRate = numerator / denominator;
                AfterRate = (double)Math.Truncate(AfterRate * 100) / 100;
            }
        ...
        private void add_listview()
        {
            ...
            if (who_get_score == 1)
            {
                items.SubItems.Add(p1_Winrate.ToString());
                items.SubItems.Add(p1_Loserate.ToString());
        ...
        // ------------------------------------------- EVENT 설정 ------------------------------------------- //
        private void event_set_Click(object sender, EventArgs e)
        {
            info_panel.Visible = false;
            picture.Visible = false;
            guess_panel.Visible = false;
        ...
        private void set_over_Click(object sender, EventArgs e)
        {
            ...
            player1Winrate = firstWinrate1;
            player2Winrate = firstWinrate2;
            log.Clear();
